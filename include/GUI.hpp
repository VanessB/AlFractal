...
namespace alfrac
{
    ...
    protected:
        ...
        sf::View view;           // Основная камера.
        sf::View ui_view;        // Камера для интерфейса.

        //int64_t min_scale_power = 0; // минимальная степень приближения, при которой возможен запрос новых тайлов (см. Settings::request_on_downscale)
